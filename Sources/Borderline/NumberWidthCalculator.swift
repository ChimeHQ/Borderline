...
public final class NumberWidthCalculator {
	public typealias AttributeProvider = () -> [[NSAttributedString.Key: Any]]

	private var lastDigitCount = 0
	private var cachedWidth: CGFloat?
	private let attributeProvider: AttributeProvider

	public var reservedDigits = 3 {
		didSet {
	...
	public init(attributeProvider: @escaping AttributeProvider) {
		self.attributeProvider = attributeProvider
	}

	public func invalidateWidth() {
		lastDigitCount = 0
		cachedWidth = nil
	}

	public var minimumDigitsRequired: Int {
